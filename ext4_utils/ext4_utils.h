...
extern int hash_directory_index;
...
struct fs_info {
	...
	u32 flexbg_free_block;
	// MStar Android Patch End
	struct sparse_file *sparse_file;
};

// MStar Android Patch Begin
// Move and modify struct from allocate.c
struct block_group_info {
	u32 first_block;
	u32 first_flex_bg;
...
// MStar Android Patch Begin
// These variables are defined in sparse.c
...
int make_ext4fs_internal(int fd, const char *directory,
                         ...
                         struct selabel_handle *sehnd, int verbose, unsigned char padByte, int enablePad);
// MStar Android Patch End
